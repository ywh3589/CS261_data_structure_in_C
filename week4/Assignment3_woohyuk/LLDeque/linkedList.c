...
/* Name: Woohyuk Yang
 * Date: Oct. 11th ,2016
 * Solution description: function library for linked list. 
 */
...
static void init(struct LinkedList* list) {
	...
	struct Link* fSentinel = (struct Link*)malloc(sizeof(struct));
	struct Link* bSentinel = (struct Link*)malloc(sizeof(struct));
	//fSentinel->value = 0;
	//bSentinel->value = 0;
